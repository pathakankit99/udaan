        ...
        <section id="contact" className="min-height-100 flex flex-wrap justify-center items-center">
            ...
            <div className="pb-4">
                ...
                <div className="flex items-center pb-4">
                    <a href="tel:+918967379419" className="flex items-center">
                        <span  className="mr-2 mb-2 red-icons">
                            <FaPhoneAlt/>
                        </span> 
                    </a>
                    <div>
                    <a href="tel:+918967379419" className="flex items-center hover:underline">
                        (+91) 89673 79419 (Sanjay Singh),
                    </a>
                    <a href="tel:+919330273310" className="flex items-center hover:underline">
                        (+91) 93302 73310 (Biswajit Mandol)
                    </a>
                    </div>
                </div>
